...
class ConnectToServerWindowDesign(object):
    def setupUi(self, MainWindow, language: str = "ua"):
        ...
        self.TRANSs_note = QtWidgets.QLabel(parent=self.frame_3)
        self.TRANSs_note.setGeometry(QtCore.QRect(10, 160, 861, 20))
        self.TRANSs_note.setStyleSheet("color: white;")
        self.TRANSs_note.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.TRANSs_note.setObjectName("TRANSs_note")
